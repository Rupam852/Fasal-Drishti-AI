    ...
    <div className="glass-panel p-5 rounded-2xl border border-white/10 shadow-xl text-left">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-0.5">
            Realtime diagnosis streaming from Android client devices to Supabase cloud
          </p>
        </div>
      ...
      {scans.length === 0 ? (
        <div className="p-8 text-center rounded-2xl bg-slate-900/40 border border-white/5 space-y-3">
          ...
          <h4 className="text-sm font-bold text-white">Live Scan Telemetry Active</h4>
          <p className="text-xs text-slate-400 max-w-md mx-auto leading-relaxed">
            Connected to Supabase PostgreSQL database. As farmers perform crop leaf scans in the Android app, their diagnoses, images, and confidence ratings will appear here in real-time.
          </p>
          <div className="pt-2">
            <span className="text-[11px] px-3 py-1 rounded-full bg-slate-800 text-emerald-300 font-mono border border-white/5 inline-flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-ping" />
              Listening on table: public.scans
            </span>
          </div>
        </div>
      ) : (
